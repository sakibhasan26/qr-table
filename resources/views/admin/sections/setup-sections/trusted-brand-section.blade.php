...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#client-feedback-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Brands") }}</a>
                </div>
            </div>
    ...
    {{-- Client Update --}}
    <div id="trusted-brand-update" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
...
@push('script')
    ...
    <script>
        ...
        openModalWhenError("trusted-brand-update","#trusted-brand-update");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#trusted-brand-update");
            ...
            fileHolderPreviewReInit("#trusted-brand-update input[name=image_edit]");

            openModalBySelector("#trusted-brand-update");
