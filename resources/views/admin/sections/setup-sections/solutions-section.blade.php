        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#solution-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Solution") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><a href="{{ $item->language->$system_default_lang->link ?? "" }}" class="text--danger">{{ $item->language->$system_default_lang->title ?? "" }}</a></td>
