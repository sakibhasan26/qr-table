...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#about-page-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-about-page-item')

    {{-- About Page edit modal --}}
    <div id="about-page-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("about-page-item-add","#about-page-item-add");
        openModalWhenError("about-page-item-edit","#about-page-item-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#about-page-item-edit");
            ...
            openModalBySelector("#about-page-item-edit");
