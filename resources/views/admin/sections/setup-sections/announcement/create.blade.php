...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.setup.sections.announcement.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form--control select2-basic">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}">{{ $category->name?->language?->$lang_code?->name ?? null }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
