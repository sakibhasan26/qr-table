@if (admin_permission_by_name("admin.social.auth.update"))
    <div id="edit-modal" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("Update Driver") }}: <span class="extension-name"></h5>
            </div>
        ...
        <script>
            (function($) {
                ...
                $('.edit-button').on('click', function(e) {
                    ...
                    var shortcode = $(this).data('credentials');
