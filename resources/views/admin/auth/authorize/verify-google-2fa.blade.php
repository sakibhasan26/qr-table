...
@section('section')
    <div class="account-wrapper">
        <div class="account-header">
            ...
            <p class="mt-3">{{ __("Please Verify 2FA Authentication Using Valid Code")  }}</p>
        </div>
        <form class="account-form" action="{{ setRoute('admin.authorize.google.2fa.submit') }}" method="POST">
            ...
            <div class="info-block">
                <p class="text--warning">
                    ...
                    <i>If something wrong with your authentication process you can reset your password to get the dashboard access</i>
                </p>
            </div>
